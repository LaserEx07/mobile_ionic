...
function openDB(name4, version3, {
  blocked,
  upgrade,
  blocking,
  terminated
...
var FirebaseMessagingWeb = class _FirebaseMessagingWeb extends WebPlugin {
  constructor() {
    super();
  ...
  checkPermissions() {
    return __async(this, null, function* () {
      const isSupported = yield isWindowSupported();
      if (!isSupported) {
        return {
          receive: "denied"
        };
  ...
  getToken(options) {
    return __async(this, null, function* () {
      const messaging = getMessagingInWindow();
      const token = yield getToken2(messaging, {
...
@firebase/messaging/dist/esm/index.esm2017.js:
   ...
   *)
*/
//# sourceMappingURL=web-4WGNIBJG.js.map
